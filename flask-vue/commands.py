...
from flask.ext.script import prompt, prompt_bool
...
class CreateDB(Command):
    ...
    def run(self):
        try:
            from extensions.database import create_all
...
class DropDB(Command):
    ...
    def run(self):
        try:
            from extensions.database import drop_all
...
class Apps(Command):
    ...
    def get_options(self):
        return [
            ...
            Option('--name', dest='name', type=str),
            Option('--folder', '-f', dest='folder',
                   default=self.APPS_FOLDER, type=str),
        ]
    ...
    def get_options(self):
        return [
            ...
            Option('--failfast', dest='failfast',
                    default=self.failfast, action='store_true')
        ]
